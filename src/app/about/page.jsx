    ...
    <div className="bg-gray-100 min-h-screen flex items-center justify-center">
      <div className="max-w-2xl p-8 bg-white shadow-lg rounded-md">
        ...
        <p className="text-gray-700 mb-4">
          Welcome to Infintrix Technologies, where innovation meets excellence
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700">
            Our mission is to be at the forefront of technological advancements,
            providing our clients with bespoke solutions that not only meet
            their current needs but also anticipate and adapt to future
            challenges.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6">
            <li className="text-gray-700">
              Expertise: Our team comprises skilled professionals with a diverse
              range of expertise in web and mobile development technologies.
            </li>
            <li className="text-gray-700">
              Client-Centric Approach: Your success is our priority. We believe
              in fostering collaborative partnerships with our clients.
            </li>
            <li className="text-gray-700">
              Innovation: Innovation is the heartbeat of our company. We embrace
